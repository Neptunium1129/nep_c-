...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
			...
			<form action="회원등록" method="POST" id="form_register">
...
$(document).ready(function(){
    $("#btnSearchAddress").click(function(){
    	...
    	주소조회창= window.open("주소조회준비" ,'popupNo01', 'width=300, height=400,left=500,top=200, scrollbars= 0, toolbar=0, menubar=no');
    ...
    $("#btnCheckid").click(function(){      
    	아이디중복검사창 =  window.open("아이디중복검사준비" ,'popupNo01', 'width=300, height=400,left=500,top=200, scrollbars= 0, toolbar=0, menubar=no');
    });
